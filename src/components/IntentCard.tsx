        ...
        <div className="flex gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-1 mb-0.5">
              ...
              <span className="text-[var(--muted)] text-[15px]">@{intent.authorName.toLowerCase().replace(/\s/g, "")}</span>
            ...
            <div className="flex justify-between max-w-[400px] -ml-2">
              <button className="flex items-center gap-1.5 text-[var(--muted)] hover:text-[var(--accent)] group transition-colors" onClick={(e) => e.preventDefault()}>
              ...
              <button className="flex items-center gap-1.5 text-[var(--muted)] hover:text-[var(--green)] group transition-colors" onClick={(e) => e.preventDefault()}>
              ...
              <button className="flex items-center text-[var(--muted)] hover:text-[var(--accent)] group transition-colors" onClick={(e) => e.preventDefault()}>
                <div className="p-2 rounded-full group-hover:bg-[var(--accent-glow)] transition-colors">
                  <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.5">
