...
const integrations = [
  { name: "Gmail", desc: "メール送受信" },
  { name: "Google Calendar", desc: "予定管理" },
  { name: "Google Drive", desc: "ファイル参照" },
  { name: "Notion", desc: "ナレッジ同期" },
  { name: "Slack", desc: "チャット連携" },
  { name: "Trello", desc: "タスク管理" },
  { name: "X (Twitter)", desc: "SNS投稿" },
  { name: "LINE", desc: "ログイン連携" },
];
