      ...
      <section className="px-5 py-16 bg-gray-50">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 sm:gap-12 opacity-70">
            ...
            {/* freee */}
            <svg viewBox="0 0 100 32" className="h-6 w-auto" aria-label="freee">
              <text x="0" y="26" fill="#2ecc71" fontSize="28" fontWeight="bold" fontFamily="Arial, sans-serif">freee</text>
            </svg>
          </div>
        </div>
      </section>
